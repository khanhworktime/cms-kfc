            ...
            {!isLoading && <>
                ...
                <div className={"flex gap-4 flex-wrap"}>
                    <Link to={location.pathname + "/facility"}
                          className={"my-4 overflow-hidden h-[25vh] flex flex-col w-[25vh] bg-white rounded-md shadow hover:shadow-lg hover:scale-[1.05] transition-all"}>
                    ...
                    <Link to={location.pathname + "/in-outbound"}
                          className={"my-4 overflow-hidden h-[25vh] flex flex-col w-[25vh] bg-white rounded-md shadow hover:shadow-lg hover:scale-[1.05] transition-all"}>
